...
Thanks for considering a contribution to Bounty Sieve. This project is intentionally small, offline by default, and read-only while the public intake workflow is being shaped.
...
- Do not add code that clones repositories, opens pull requests, contacts maintainers, connects wallets, uses credentials, stars repositories, claims work, logs in, comments, or attempts prompt/private-data exfiltration.
